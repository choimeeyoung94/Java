...
public class BankAccount {
   ...
   */
  public long withdrawal(long money) throws WithrawalException{
    
    if (money < 0 || money > balance) { 
      throw new WithrawalException("마이너스 출금과 잔액보다 큰 금액의 출금은 불가능합니다.");
    }
    balance -= money;
    return money;
  }
   ...
   * @throws DepositException 
   * @throws WithrawalException 
   */
  public void transfer(BankAccount bankAccount, long money) throws DepositException, WithrawalException {
